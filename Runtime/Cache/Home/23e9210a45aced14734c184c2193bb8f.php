...
<html lang="zh-cn">
  ...
  <body>
    <div class="container">
      <div class="row">
        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-lg-3 col-md-4 col-sm-6 illu" style="height:100px;">
                <dl>
                    <dt><?php echo ($vo["server_name"]); ?></dt>
                    <dd>
                        <ul>
                            <li><a href="/logsystem/index.php/Home/Index/getLog/id/<?php echo ($vo["id"]); ?>">获取日志文件列表</a></li>
                        </ul>
                    </dd>
                </dl> 
